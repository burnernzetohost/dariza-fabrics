                ...
                <div className="lg:grid lg:grid-cols-2 lg:gap-x-12 lg:items-start">
                    ...
                    <div className="mt-10 px-4 sm:mt-16 sm:px-0 lg:mt-0">
                        <div className="flex justify-between items-start">
                            ...
                            <button className="p-2 text-gray-500 hover:text-red-500 transition"><Heart className="w-6 h-6" /></button>
                        </div>
                        ...
                        {sizes.length > 0 && (
                            <div className="mt-8">
                                ...
                                <div className="grid grid-cols-5 gap-3">
                                    {sizes.map((size) => (
                                        <button key={size} onClick={() => setSelectedSize(size)} className={`flex items-center justify-center py-3 border text-sm font-medium uppercase transition-all ${selectedSize === size ? 'border-[#012d20] bg-[#012d20] text-white' : 'border-gray-200 text-gray-900 hover:border-gray-900'}`}>
                                            {size}
                                        </button>
                                    ))}
                                </div>
                        ...
                        <div className="mt-10 flex gap-4">
                            <button onClick={handleAddToCart} className="flex-1 bg-[#012d20] text-white py-4 px-8 uppercase tracking-widest text-sm font-bold hover:bg-[#001a12] transition">Add to Cart</button>
